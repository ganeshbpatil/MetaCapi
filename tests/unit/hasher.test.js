...
describe('buildUserData', () => {
  ...
  test('includes lead_id for Facebook Lead Ads', () => {
    const ud = buildUserData(lead);
    expect(ud.lead_id).toBe('2468013579135790');
  });
});
